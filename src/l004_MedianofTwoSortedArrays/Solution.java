package l004_MedianofTwoSortedArrays;
 ...
 * should be O(log (m+n)).
 * 
 * 题目大意 两个排序数组，找这两个排序数组的中位数，时间复杂度为O(log(m+n))
 * 
 * 解题思路 采用类二分查找算法
 * 
 * @author he
...
public class Solution {
	...
	public static void main(String[] args) {
		...
		System.out.println(findMedianSortedArrays(x1, x2));
		System.out.println(findMedianSortedArrays(y1, y2));
	}
